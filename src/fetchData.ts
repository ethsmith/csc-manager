...
function parseRow(r: string[]): PlayerStats | null {
  ...
  return {
    ...
    tier: r[2] ?? '',
        ...
        manAdvantageKills: num(r[110]),
        manAdvantageKillsPct: num(r[111]),
        manDisadvantageDeaths: num(r[112]),
        manDisadvantageDeathsPct: num(r[113]),
        lowBuyKills: num(r[114]),
        lowBuyKillsPct: num(r[115]),
        disadvantagedBuyKills: num(r[116]),
        disadvantagedBuyKillsPct: num(r[117]),
        pistolRoundsPlayed: num(r[118]),
        pistolRoundKills: num(r[119]),
        pistolRoundDeaths: num(r[120]),
        pistolRoundDamage: num(r[121]),
        pistolRoundsWon: num(r[122]),
        pistolRoundSurvivals: num(r[123]),
        pistolRoundMultiKills: num(r[124]),
        pistolRoundRating: num(r[125]),
        tRoundsPlayed: num(r[126]),
        tKills: num(r[127]),
        tDeaths: num(r[128]),
        tDamage: num(r[129]),
        tSurvivals: num(r[130]),
        tRoundsWithMultiKill: num(r[131]),
        tEcoKillValue: num(r[132]),
        tKast: num(r[133]),
        tClutchRounds: num(r[134]),
        tClutchWins: num(r[135]),
        tManAdvantageKills: num(r[136]),
        tManAdvantageKillsPct: num(r[137]),
        tManDisadvantageDeaths: num(r[138]),
        tManDisadvantageDeathsPct: num(r[139]),
        tRating: num(r[140]),
        tEcoRating: num(r[141]),
        ctRoundsPlayed: num(r[142]),
        ctKills: num(r[143]),
        ctDeaths: num(r[144]),
        ctDamage: num(r[145]),
        ctSurvivals: num(r[146]),
        ctRoundsWithMultiKill: num(r[147]),
        ctEcoKillValue: num(r[148]),
        ctKast: num(r[149]),
        ctClutchRounds: num(r[150]),
        ctClutchWins: num(r[151]),
        ctManAdvantageKills: num(r[152]),
        ctManAdvantageKillsPct: num(r[153]),
        ctManDisadvantageDeaths: num(r[154]),
        ctManDisadvantageDeathsPct: num(r[155]),
        ctRating: num(r[156]),
        ctEcoRating: num(r[157]),
        ancientRating: num(r[158]),
        ancientGames: num(r[159]),
        anubisRating: num(r[160]),
        anubisGames: num(r[161]),
        dust2Rating: num(r[162]),
        dust2Games: num(r[163]),
        infernoRating: num(r[164]),
        infernoGames: num(r[165]),
        mirageRating: num(r[166]),
        mirageGames: num(r[167]),
        nukeRating: num(r[168]),
        nukeGames: num(r[169]),
        overpassRating: num(r[170]),
        overpassGames: num(r[171]),
  };
}
