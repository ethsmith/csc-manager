...
function parseRow(r: string[]): PlayerStats | null {
  ...
  return {
    ...
    tier: r[2] ?? '',
        ...
        ancientRating: num(r[160]),
        ancientGames: num(r[161]),
        anubisRating: num(r[162]),
        anubisGames: num(r[163]),
        dust2Rating: num(r[164]),
        dust2Games: num(r[165]),
        infernoRating: num(r[166]),
        infernoGames: num(r[167]),
        mirageRating: num(r[168]),
        mirageGames: num(r[169]),
        nukeRating: num(r[170]),
        nukeGames: num(r[171]),
        overpassRating: num(r[172]),
        overpassGames: num(r[173]),
  };
}
