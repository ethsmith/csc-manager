...
const STAT_FIELDS: StatFieldDef[] = [
  ...
  { key: 'knifeKills', label: 'Knife Kills', type: 'number', group: 'Combat' },
  { key: 'pistolVsRifleKills', label: 'Pistol vs Rifle Kills', type: 'number', group: 'Combat' },
  { key: 'perfectKills', label: 'Perfect Kills', type: 'number', group: 'Combat' },
  { key: 'timeAlivePerRound', label: 'Time Alive/Rd', type: 'number', group: 'Combat' },
  { key: 'lastAliveRounds', label: 'Last Alive Rounds', type: 'number', group: 'Combat' },
  { key: 'lastAlivePct', label: 'Last Alive %', type: 'number', group: 'Combat' },
  { key: 'exitFrags', label: 'Exit Frags', type: 'number', group: 'Combat' },
  { key: 'earlyDeaths', label: 'Early Deaths', type: 'number', group: 'Combat' },
  { key: 'savesOnLoss', label: 'Saves On Loss', type: 'number', group: 'Combat' },
  { key: 'savesPerRoundLoss', label: 'Saves/Rd Loss', type: 'number', group: 'Combat' },
  // Opening Duels
  ...
  { key: 'openingSuccesses', label: 'Opening Successes', type: 'number', group: 'Opening' },
  ...
  { key: 'openingAttemptsPct', label: 'Opening Attempts %', type: 'number', group: 'Opening' },
  { key: 'openingSuccessPct', label: 'Opening Success %', type: 'number', group: 'Opening' },
  { key: 'roundsWonAfterOpening', label: 'Rounds Won After Opening', type: 'number', group: 'Opening' },
  ...
  { key: 'probabilitySwingPerRound', label: 'Prob Swing/Rd', type: 'number', group: 'Economy' },
  { key: 'lowBuyKills', label: 'Low Buy Kills', type: 'number', group: 'Economy' },
  { key: 'lowBuyKillsPct', label: 'Low Buy Kills %', type: 'number', group: 'Economy' },
  { key: 'disadvantagedBuyKills', label: 'Disadvantaged Buy Kills', type: 'number', group: 'Economy' },
  { key: 'disadvantagedBuyKillsPct', label: 'Disadvantaged Buy Kills %', type: 'number', group: 'Economy' },
  // Clutch
  { key: 'clutchRounds', label: 'Clutch Rounds', type: 'number', group: 'Clutch' },
  { key: 'clutchWins', label: 'Clutch Wins', type: 'number', group: 'Clutch' },
  { key: 'clutchPointsPerRound', label: 'Clutch Points/Rd', type: 'number', group: 'Clutch' },
  ...
  // Trading
  { key: 'tradeKills', label: 'Trade Kills', type: 'number', group: 'Trading' },
  { key: 'tradeKillsPerRound', label: 'Trade Kills/Rd', type: 'number', group: 'Trading' },
  { key: 'tradeKillsPct', label: 'Trade Kills %', type: 'number', group: 'Trading' },
  { key: 'fastTrades', label: 'Fast Trades', type: 'number', group: 'Trading' },
  { key: 'tradedDeaths', label: 'Traded Deaths', type: 'number', group: 'Trading' },
  { key: 'tradedDeathsPerRound', label: 'Traded Deaths/Rd', type: 'number', group: 'Trading' },
  { key: 'tradedDeathsPct', label: 'Traded Deaths %', type: 'number', group: 'Trading' },
  { key: 'tradeDenials', label: 'Trade Denials', type: 'number', group: 'Trading' },
  { key: 'savedByTeammate', label: 'Saved By Teammate', type: 'number', group: 'Trading' },
  { key: 'savedByTeammatePerRound', label: 'Saved By Teammate/Rd', type: 'number', group: 'Trading' },
  { key: 'savedTeammate', label: 'Saved Teammate', type: 'number', group: 'Trading' },
  { key: 'savedTeammatePerRound', label: 'Saved Teammate/Rd', type: 'number', group: 'Trading' },
  { key: 'openingDeathsTraded', label: 'Opening Deaths Traded', type: 'number', group: 'Trading' },
  { key: 'openingDeathsTradedPct', label: 'Opening Deaths Traded %', type: 'number', group: 'Trading' },
  // Multi-kills
  ...
  { key: 'roundsWithKill', label: 'Rounds w/ Kill', type: 'number', group: 'Multi-Kill' },
  { key: 'roundsWithKillPct', label: 'Rounds w/ Kill %', type: 'number', group: 'Multi-Kill' },
  { key: 'roundsWithMultiKill', label: 'Rounds w/ Multi-Kill', type: 'number', group: 'Multi-Kill' },
  { key: 'roundsWithMultiKillPct', label: 'Rounds w/ Multi-Kill %', type: 'number', group: 'Multi-Kill' },
  { key: 'killsInWonRounds', label: 'Kills In Won Rounds', type: 'number', group: 'Multi-Kill' },
  { key: 'killsPerRoundWin', label: 'Kills/Rd Win', type: 'number', group: 'Multi-Kill' },
  { key: 'damageInWonRounds', label: 'Damage In Won Rounds', type: 'number', group: 'Multi-Kill' },
  { key: 'damagePerRoundWin', label: 'Damage/Rd Win', type: 'number', group: 'Multi-Kill' },
  // Support
  { key: 'supportRounds', label: 'Support Rounds', type: 'number', group: 'Support' },
  { key: 'supportRoundsPct', label: 'Support Rounds %', type: 'number', group: 'Support' },
  { key: 'assistedKills', label: 'Assisted Kills', type: 'number', group: 'Support' },
  { key: 'assistedKillsPct', label: 'Assisted Kills %', type: 'number', group: 'Support' },
  { key: 'assistsPerRound', label: 'Assists/Rd', type: 'number', group: 'Support' },
  { key: 'attackRounds', label: 'Attack Rounds', type: 'number', group: 'Support' },
  { key: 'attacksPerRound', label: 'Attacks/Rd', type: 'number', group: 'Support' },
  // Man Advantage
  { key: 'manAdvantageKills', label: 'Man Advantage Kills', type: 'number', group: 'Man Advantage' },
  { key: 'manAdvantageKillsPct', label: 'Man Advantage Kills %', type: 'number', group: 'Man Advantage' },
  { key: 'manDisadvantageDeaths', label: 'Man Disadvantage Deaths', type: 'number', group: 'Man Advantage' },
  { key: 'manDisadvantageDeathsPct', label: 'Man Disadvantage Deaths %', type: 'number', group: 'Man Advantage' },
  // AWP
  { key: 'awpKills', label: 'AWP Kills', type: 'number', group: 'AWP' },
  { key: 'awpKillsPerRound', label: 'AWP Kills/Rd', type: 'number', group: 'AWP' },
  { key: 'awpKillsPct', label: 'AWP Kills %', type: 'number', group: 'AWP' },
  { key: 'roundsWithAwpKill', label: 'Rounds w/ AWP Kill', type: 'number', group: 'AWP' },
  { key: 'roundsWithAwpKillPct', label: 'Rounds w/ AWP Kill %', type: 'number', group: 'AWP' },
  { key: 'awpMultiKillRounds', label: 'AWP Multi-Kill Rds', type: 'number', group: 'AWP' },
  { key: 'awpMultiKillRoundsPerRound', label: 'AWP Multi-Kill Rds/Rd', type: 'number', group: 'AWP' },
  { key: 'awpOpeningKills', label: 'AWP Opening Kills', type: 'number', group: 'AWP' },
  { key: 'awpOpeningKillsPerRound', label: 'AWP Opening Kills/Rd', type: 'number', group: 'AWP' },
  { key: 'awpDeaths', label: 'AWP Deaths', type: 'number', group: 'AWP' },
  { key: 'awpDeathsNoKill', label: 'AWP Deaths No Kill', type: 'number', group: 'AWP' },
  // Utility
  ...
  { key: 'utilityKillsPer100Rounds', label: 'Util Kills/100 Rds', type: 'number', group: 'Utility' },
  { key: 'flashesThrown', label: 'Flashes Thrown', type: 'number', group: 'Utility' },
  { key: 'flashesThrownPerRound', label: 'Flashes Thrown/Rd', type: 'number', group: 'Utility' },
  { key: 'flashAssists', label: 'Flash Assists', type: 'number', group: 'Utility' },
  { key: 'flashAssistsPerRound', label: 'Flash Assists/Rd', type: 'number', group: 'Utility' },
  { key: 'enemyFlashDurationPerRound', label: 'Enemy Flash/Rd', type: 'number', group: 'Utility' },
  { key: 'teamFlashCount', label: 'Team Flash Count', type: 'number', group: 'Utility' },
  { key: 'teamFlashDurationPerRound', label: 'Team Flash/Rd', type: 'number', group: 'Utility' },
  // Pistol
  ...
  { key: 'pistolRoundDeaths', label: 'Pistol Deaths', type: 'number', group: 'Pistol' },
  { key: 'pistolRoundDamage', label: 'Pistol Damage', type: 'number', group: 'Pistol' },
  { key: 'pistolRoundsWon', label: 'Pistol Rounds Won', type: 'number', group: 'Pistol' },
  { key: 'pistolRoundSurvivals', label: 'Pistol Survivals', type: 'number', group: 'Pistol' },
  { key: 'pistolRoundMultiKills', label: 'Pistol Multi-Kills', type: 'number', group: 'Pistol' },
  { key: 'pistolRoundRating', label: 'Pistol Rating', type: 'number', group: 'Pistol' },
  // T Side
  { key: 'tRoundsPlayed', label: 'T Rounds Played', type: 'number', group: 'T Side' },
  { key: 'tKills', label: 'T Kills', type: 'number', group: 'T Side' },
  { key: 'tDeaths', label: 'T Deaths', type: 'number', group: 'T Side' },
  { key: 'tDamage', label: 'T Damage', type: 'number', group: 'T Side' },
  { key: 'tSurvivals', label: 'T Survivals', type: 'number', group: 'T Side' },
  { key: 'tRoundsWithMultiKill', label: 'T Multi-Kill Rds', type: 'number', group: 'T Side' },
  { key: 'tEcoKillValue', label: 'T Eco Kill Value', type: 'number', group: 'T Side' },
  { key: 'tKast', label: 'T KAST', type: 'number', group: 'T Side' },
  { key: 'tClutchRounds', label: 'T Clutch Rounds', type: 'number', group: 'T Side' },
  { key: 'tClutchWins', label: 'T Clutch Wins', type: 'number', group: 'T Side' },
  { key: 'tManAdvantageKills', label: 'T Man Advantage Kills', type: 'number', group: 'T Side' },
  { key: 'tManAdvantageKillsPct', label: 'T Man Advantage Kills %', type: 'number', group: 'T Side' },
  { key: 'tManDisadvantageDeaths', label: 'T Man Disadvantage Deaths', type: 'number', group: 'T Side' },
  { key: 'tManDisadvantageDeathsPct', label: 'T Man Disadvantage Deaths %', type: 'number', group: 'T Side' },
  { key: 'tRating', label: 'T Rating', type: 'number', group: 'T Side' },
  { key: 'tEcoRating', label: 'T Eco Rating', type: 'number', group: 'T Side' },
  // CT Side
  { key: 'ctRoundsPlayed', label: 'CT Rounds Played', type: 'number', group: 'CT Side' },
  { key: 'ctKills', label: 'CT Kills', type: 'number', group: 'CT Side' },
  { key: 'ctDeaths', label: 'CT Deaths', type: 'number', group: 'CT Side' },
  { key: 'ctDamage', label: 'CT Damage', type: 'number', group: 'CT Side' },
  { key: 'ctSurvivals', label: 'CT Survivals', type: 'number', group: 'CT Side' },
  { key: 'ctRoundsWithMultiKill', label: 'CT Multi-Kill Rds', type: 'number', group: 'CT Side' },
  { key: 'ctEcoKillValue', label: 'CT Eco Kill Value', type: 'number', group: 'CT Side' },
  { key: 'ctKast', label: 'CT KAST', type: 'number', group: 'CT Side' },
  { key: 'ctClutchRounds', label: 'CT Clutch Rounds', type: 'number', group: 'CT Side' },
  { key: 'ctClutchWins', label: 'CT Clutch Wins', type: 'number', group: 'CT Side' },
  { key: 'ctManAdvantageKills', label: 'CT Man Advantage Kills', type: 'number', group: 'CT Side' },
  { key: 'ctManAdvantageKillsPct', label: 'CT Man Advantage Kills %', type: 'number', group: 'CT Side' },
  { key: 'ctManDisadvantageDeaths', label: 'CT Man Disadvantage Deaths', type: 'number', group: 'CT Side' },
  { key: 'ctManDisadvantageDeathsPct', label: 'CT Man Disadvantage Deaths %', type: 'number', group: 'CT Side' },
  { key: 'ctRating', label: 'CT Rating', type: 'number', group: 'CT Side' },
  { key: 'ctEcoRating', label: 'CT Eco Rating', type: 'number', group: 'CT Side' },
  // Maps
